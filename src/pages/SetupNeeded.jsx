...
import InspectorMark from '../components/InspectorMark'
    ...
    <div className="aurora flex min-h-screen items-center justify-center p-6 text-white">
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          <div className="grid h-12 w-12 place-items-center rounded-2xl bg-white"><InspectorMark size={34} /></div>
          <div>
            <h1 className="text-2xl font-extrabold">Inspections Portal</h1>
