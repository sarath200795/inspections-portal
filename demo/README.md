# Tutorial video harness — inspections-portal

Regenerates the screen-recorded tutorial (`inspections-portal.mp4`) by driving the **real app**
...
```
The video is written to `demo/out/inspections-portal.mp4`.
